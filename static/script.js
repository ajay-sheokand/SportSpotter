document.addEventListener('DOMContentLoaded', function () {
    ...
    // Define image URLs
    const lightImage = 'static/satellite-preview.png';
    const darkImage = 'static/default-preview.png';
    ...
    const LocationControl = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            icon.src = 'static/icons/location-icon.png';
    ...
    const sportIconMapping = {
        soccer: 'static/icons/football-icon.png',
        // soccer: "{{ url_for('static', filename='images/icons/football-icon.png') }}",
        tennis: 'static/icons/tennis-icon.png',
        boules: 'static/icons/boules.png',
        speckbrett: 'static/icons/speckbrett.png',
        skateboard: 'static/icons/skateboard.png',
        basketball: 'static/icons/basketball.png',
        beachvolleyball: 'static/icons/beachvolleyball.png',
        team_handball: 'static/icons/team_handball.png',
        equestrian: 'static/icons/equestrian.png',
        paintball: 'static/icons/paintball.png',
        table_tennis: 'static/icons/table_tennis.png',
        archery: 'static/icons/archery.png'
    ...
    function getIconSize(zoomLevel) {
        ...
        if (zoomLevel >= 16) return baseSize * 2.3;      // Very close
